...
const DieCapabilities = () => {
  const DieContent = [
    {
      icon: Die1,
      title: 'Custom-designed extrusion dies for aluminium profiles',
    },
    {
      icon: Die2,
      title: 'Dies for architectural, structural, automotive, and industrial profiles',
    },
    {
      icon: Die3,
      title: 'Tooling for hollow, solid, and semi-hollow sections',
    },
    {
      icon: Die4,
      title: 'Rapid prototyping, revisions, and engineering support',
    },
  ];
    ...
    <div className="py-12 px-4 sm:px-6 lg:px-20">
      ...
      >
        <h1 className="text-3xl sm:text-4xl font-semibold">
          Our Die <span className="text-lighter">Capabilities Include</span>
        </h1>
      </motion.div>
...
export default DieCapabilities;