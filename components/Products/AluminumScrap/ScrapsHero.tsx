...
import AluminumScrapHeroImg from '@/assets/Product/aluminum-scrap.png'

const ScrapsHero: React.FC = () => {
  ...
  return (
    <section className="relative w-full h-[70dvh] flex items-center justify-center overflow-hidden z-50">
      ...
      >
        ...
        >
          High Quality Aluminium Scrap for Smarter,  Greener Aluminium Manufacturing
        </motion.p>
      </motion.div>
    </section>
  );
