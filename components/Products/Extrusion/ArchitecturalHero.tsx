...
import ArchitecturalHero from '@/assets/Product/Extrusions/architectural.jpg';


const ArchitecturalExtrusionHero: React.FC = () => {
  ...
  return (
    <section className="relative w-full h-[70dvh] flex items-center justify-center overflow-hidden z-50">
      ...
      >
        ...
        >
          Premium Architectural Aluminum Profiles - Engineered for Strength, Designed for Elegance
        </motion.p>
      </motion.div>
    </section>
  );
...
export default ArchitecturalExtrusionHero;