...
import StructuralHero from '@/assets/Product/Extrusions/structural.jpg';


const StructuralExtrusionHero: React.FC = () => {
  ...
  return (
    <section className="relative w-full h-[70dvh] flex items-center justify-center overflow-hidden z-50">
      ...
      >
        <Image
          src={StructuralHero}
          alt="Structural Extrusion Hero Background"
          fill
      ...
      >
        ...
        >
          High Strength Structural Aluminium Profile - Built for Heavy - Duty Performance
        </motion.p>
      </motion.div>
    </section>
  );
...
export default StructuralExtrusionHero;