...
import ByIndustryHeroImg from '@/assets/ByIndustry/ByIndustryHeroBG.png';

const ByIndustryHero: React.FC = () => {
  ...
  return (
    <section className="relative w-full h-screen flex items-center justify-center overflow-hidden z-50">
      ...
      >
        <Image
          src={ByIndustryHeroImg}
          alt="By Industry Hero Background"
          fill
      ...
      >
        ...
        >
          Aluminum Solutions, Engineered for Every Sector
        </motion.p>
      </motion.div>
    </section>
  );
