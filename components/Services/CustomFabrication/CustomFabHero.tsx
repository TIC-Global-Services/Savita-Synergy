...
import CustomFabImg from '@/assets/Services/CustomFabrication.png'

const CustomFabHero: React.FC = () => {
  ...
  return (
    <section className="relative w-full h-[70dvh] flex items-center justify-center overflow-hidden z-50">
      ...
      >
        <Image
          src={CustomFabImg}
          alt="Custom Fab Hero Background"
          fill
      ...
      >
        ...
        >
          Custom Aluminium Fabrication - Engineered to Fit  your Design, Function & Finish
        </motion.p>
      </motion.div>
    </section>
  );
