...
import AnodizingHeroImg from '@/assets/Services/Banner/anodizing.png'
...
const AnodizingHero: React.FC = () => {
  ...
  return (
    <section className="relative w-full h-[70dvh] flex items-center justify-center overflow-hidden z-50">
      ...
      >
        <Image
          src={AnodizingHeroImg}
          alt="Aluminum Scrap Hero Background"
          fill
      ...
      >
        ...
        >
         Anodized Aluminium Surface Finish
        </motion.h1>
        <motion.p
          initial={{ opacity: 0, x: -60 }}
          animate={{ opacity: 1, x: 0 }}
        ...
        >
          3x Stronger, 60% Lighter - The Advanced Aluminium Finish Built  to Outlast and outeperform
        </motion.p>
      </motion.div>
    </section>
  );
